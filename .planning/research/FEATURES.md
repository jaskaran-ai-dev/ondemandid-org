...
**Nice to have before public launch:** 7. Uptime monitoring (Better Stack) 8. Audit log table (minimal schema — can be enhanced later)

**Safe to defer:** 9. OpenTelemetry distributed tracing 10. Session replay (Sentry enables it by default — just configure) 11. Admin dashboard 12. SOC 2 formal process
