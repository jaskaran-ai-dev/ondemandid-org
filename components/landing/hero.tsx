  ...
  return (
    <section className="relative overflow-hidden border-b border-border/60">
      ...
      <div className="mx-auto flex w-full max-w-6xl flex-col items-center px-4 pb-16 pt-14 text-center md:px-6 md:pb-24 md:pt-20">
        <div className="anim-fade-up inline-flex items-center gap-2 rounded-full border border-border bg-background/80 px-3 py-1 text-xs font-medium text-muted-foreground shadow-sm" style={{ fontFamily: 'Bespoke Stencil, sans-serif' }}>
